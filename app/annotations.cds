using { ingoKiesewetter_1_01Srv } from '../srv/service.cds';

annotate ingoKiesewetter_1_01Srv.CustomerMessage with @UI.HeaderInfo: { TypeName: 'Customer Message', TypeNamePlural: 'Customer Messages', Title: { Value: customerMessageID } };
annotate ingoKiesewetter_1_01Srv.CustomerMessage with {
  ID @UI.Hidden @Common.Text: { $value: customerMessageID, ![@UI.TextArrangement]: #TextOnly }
};
annotate ingoKiesewetter_1_01Srv.CustomerMessage with @UI.Identification: [{ Value: customerMessageID }];
annotate ingoKiesewetter_1_01Srv.CustomerMessage with {
...
annotate ingoKiesewetter_1_01Srv.CustomerMessage with @UI.LineItem: [
...
annotate ingoKiesewetter_1_01Srv.CustomerMessage with @UI.FieldGroup #Main: {
...
annotate ingoKiesewetter_1_01Srv.CustomerMessage with @UI.Facets: [
  { $Type: 'UI.ReferenceFacet', ID: 'Main', Label: 'General Information', Target: '@UI.FieldGroup#Main' }
];

annotate ingoKiesewetter_1_01Srv.CustomerMessage with @UI.SelectionFields: [
  customerMessageID
];
