...
/**
 * 
 * @On(event = { "Action1" }, entity = "ingoKiesewetter_1_01Srv.CustomerMessage")
...
try {
    ...
    customerMessage = await SELECT.one.from('IngoKiesewetter_1_01.CustomerMessage').where({ ID });
    if (!customerMessage) {
...
try {
    ...
    await UPDATE('IngoKiesewetter_1_01.CustomerMessage').set({
